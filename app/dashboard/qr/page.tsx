...
//   let hideLoading: (() => void) | null = null;
//   try {
//     setGeneratingId(id); // Set the specific ID being generated
...
//   } finally {
//     hideLoading?.();
//     setGeneratingId(null); // Reset to null
//   }
// };
...
//           </>
//         ):(
//         /* If qrBase64 is missing, show Regenerate/Retry button */
//         <Button
//           type="primary"
//           danger
//           icon={<QrcodeOutlined />}
...
//           // Disable other buttons while one is generating:
...
//           }}
//           // onClick={() => handleRegenerate(record._id)}
//         >
//           Regenerate QR
//         </Button>
//       )}
